	...
	>
		...
		<div class="max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-8 2xl:px-12 relative z-10 w-full">
			...
			<div class="text-center max-w-5xl mx-auto mb-6 sm:mb-12 lg:mb-14">
				...
				>
					AI 能在幾秒內生成代碼片段，但無法替你定義需求、拆解架構或為品質負責。我們不培養只會等答案的代碼搬運工，而是建立從「理解需求、拆解模組、提示協同、驗證除錯到系統整合」的 5 階段工程心智自問框架。
				</p>
			</div>
			...
			>
				...
				<div class="relative z-10 space-y-6">
					...
					<div class="hidden lg:block xl:hidden p-4 rounded-3xl bg-slate-950/80 border border-cyan-500/30 shadow-xl space-y-3">
