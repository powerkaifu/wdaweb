<template>
	<section id="learning-path" class="py-16 sm:py-24 lg:py-32 bg-transparent relative overflow-hidden">
		...
		<div class="max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-8 2xl:px-12 relative z-10 w-full">
			...
			<!-- 手機端橫向滑動提示 (桌機隱藏) -->
			<div class="flex sm:hidden items-center justify-center gap-2 text-xs font-mono text-cyan-400/80 -mt-4 mb-4">
			...
			>
				...
				>
					...
					<div>
						...
						<p class="text-base text-slate-300 leading-relaxed text-pretty">
							從 HTML、CSS 與 JavaScript
							開始。理解網頁如何建立、文字與畫面如何排列、互動如何發生。從「滿螢幕看不懂」慢慢走向「知道每一行程式碼正在做什麼」。
						</p>
					</div>

					<div
						class="pt-5 mt-6 border-t border-slate-800/80 flex items-center justify-between text-sm text-cyan-300 font-semibold"
					>
						<span>核心能力</span>
						<span>HTML · CSS · JavaScript 底層</span>
					</div>
				</div>

				<!-- 階段 2 -->
				<div
					class="learning-path-card card-subsurface-glow relative rounded-3xl p-5 sm:p-7 bg-slate-900/80 backdrop-blur-xl border border-slate-800/90 shadow-xl shadow-slate-950/60 flex flex-col justify-between overflow-hidden hover:border-blue-500/50 transition-[border-color,box-shadow] duration-300 cursor-default w-[84vw] max-w-[340px] shrink-0 snap-start sm:w-full sm:max-w-none sm:shrink"
				>
					<!-- 角落序號水印 -->
					<div
						class="absolute -right-2 -bottom-4 text-6xl sm:text-7xl font-mono font-black text-slate-800/20 select-none pointer-events-none"
					...
					<div>
						...
						<p class="text-base text-slate-300 leading-relaxed text-pretty">
							進入 Vue 3
							現代前端框架。不只是把零散功能寫出來，而是開始理解元件化、狀態流與架構設計，學習如何把越來越複雜的功能整理成容易維護的前端系統。
						</p>
					</div>

					<div
						class="pt-5 mt-6 border-t border-slate-800/80 flex items-center justify-between text-sm text-blue-300 font-semibold"
					>
						<span>核心能力</span>
				...
				<!-- 階段 3 -->
				<div
					class="learning-path-card card-subsurface-glow relative rounded-3xl p-5 sm:p-7 bg-slate-900/80 backdrop-blur-xl border border-slate-800/90 shadow-xl shadow-slate-950/60 flex flex-col justify-between overflow-hidden hover:border-purple-500/50 transition-[border-color,box-shadow] duration-300 cursor-default w-[84vw] max-w-[340px] shrink-0 snap-start sm:w-full sm:max-w-none sm:shrink"
				>
					<!-- 角落序號水印 -->
					<div
						class="absolute -right-2 -bottom-4 text-6xl sm:text-7xl font-mono font-black text-slate-800/20 select-none pointer-events-none"
					...
					<div>
						...
						<p class="text-base text-slate-300 leading-relaxed text-pretty">
							學習前後端資料串接、REST API
							與資料庫設計。開始理解前端介面、後端伺服器與資料庫如何真正串在一起，建立能處理真實資料與商業邏輯的完整專案。
						</p>
					</div>

					<div
						class="pt-5 mt-6 border-t border-slate-800/80 flex items-center justify-between text-sm text-purple-300 font-semibold"
					>
						<span>核心能力</span>
				...
				<!-- 階段 4 -->
				<div
					class="learning-path-card card-subsurface-glow relative rounded-3xl p-5 sm:p-7 bg-slate-900/80 backdrop-blur-xl border border-slate-800/90 shadow-xl shadow-slate-950/60 flex flex-col justify-between overflow-hidden hover:border-emerald-500/50 transition-[border-color,box-shadow] duration-300 cursor-default w-[84vw] max-w-[340px] shrink-0 snap-start sm:w-full sm:max-w-none sm:shrink"
				>
					<!-- 角落序號水印 -->
					<div
						class="absolute -right-2 -bottom-4 text-6xl sm:text-7xl font-mono font-black text-slate-800/20 select-none pointer-events-none"
					...
					<div>
						...
						<p class="text-base text-slate-300 leading-relaxed text-pretty">
							AI 可以幫你快速產生程式碼，但你需要逐漸具備提問、審核、除錯與架構判斷的能力。並透過 Git/GitHub
							團隊協同流程，將 AI 工具轉化為真實生產力。
						</p>
					</div>

					<div
						class="pt-5 mt-6 border-t border-slate-800/80 flex items-center justify-between text-sm text-emerald-300 font-semibold"
					>
						<span>核心能力</span>
