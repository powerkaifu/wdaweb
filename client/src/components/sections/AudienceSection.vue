			...
			<div class="text-center max-w-5xl xl:max-w-6xl mx-auto mb-10 sm:mb-16">
				...
				<p class="text-slate-400 mt-4 text-base sm:text-lg max-w-none mx-auto leading-relaxed text-pretty xl:whitespace-nowrap">
					<span class="block sm:inline"
						>踏入陌生的<span class="inline-block">科技領域</span>，害怕跟不上、害怕<span class="inline-block">選錯方向</span>，其實很正常。</span
					>
					<span class="block sm:inline mt-1.5 sm:mt-0 text-slate-400/90"
			...
			>
				...
				>
					<div>
						...
						<h3
							class="text-lg xl:text-xl font-extrabold text-white mb-3 tracking-tight 2xl:whitespace-nowrap"
						>
							完全沒寫過程式，我真的學得會嗎？
						</h3>
						<div
				...
				>
					<div>
						<div class="flex items-center space-x-3.5 mb-4">
							<div
								class="w-11 h-11 rounded-xl bg-blue-500/15 border border-blue-500/40 text-blue-300 flex items-center justify-center text-xl shadow-[0_0_16px_rgba(59,130,246,0.2)] flex-shrink-0"
							>
								🤖
							</div>
				...
				>
					<div>
						<div class="flex items-center space-x-3.5 mb-4">
							<div
								class="w-11 h-11 rounded-xl bg-purple-500/15 border border-purple-500/40 text-purple-300 flex items-center justify-center text-xl shadow-[0_0_16px_rgba(168,85,247,0.2)] flex-shrink-0"
							>
								🏫
							</div>
					...
					>
						<span>實體價值</span>
						<span class="text-purple-400 font-bold"> 實體環境 · 即時討論 · 持續前行 </span>
					</div>
				</div>
			</div>
		</div>
