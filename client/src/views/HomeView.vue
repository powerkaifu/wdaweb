<template>
	<div>
		<!-- 1. Hero 首頁動態輪播與核心價值定錨 (回歸人性的溫暖開場) -->
		<HeroCarousel />

		<!-- 2. 受眾心聲共鳴 (你心中可能也有這些猶豫……這些不安，我們都懂) -->
		<AudienceSection />
		...
		<section class="py-14 sm:py-20 lg:py-28 bg-slate-950/50 text-center relative overflow-hidden">
			<!-- 柔和微光 -->
			<div
			...
			<div class="max-w-5xl xl:max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 relative z-10">
				...
				<p class="text-slate-300 text-base sm:text-lg max-w-3xl mx-auto leading-relaxed text-pretty">
				...
				<div class="pt-2">
					<router-link
						to="/showcase"
						class="inline-flex items-center space-x-2 px-8 py-3.5 rounded-2xl text-base font-bold text-white bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 shadow-xl shadow-cyan-500/25 hover:shadow-cyan-500/40 hover:-translate-y-0.5 active:scale-95 transition-all"
					>
						<span>查看歷屆學員專題成果</span>
						<span>→</span>
					</router-link>
				</div>
			</div>
		...
		<section
			class="py-16 sm:py-24 lg:py-32 bg-gradient-to-b from-slate-950/60 via-slate-900/40 to-slate-950 text-center relative overflow-hidden"
		>
			<!-- 柔和環境光暈 -->
			<div
				class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[350px] bg-cyan-500/10 rounded-full blur-3xl pointer-events-none"
			></div>
			...
			<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-7 relative z-10">
				...
				<p class="text-slate-300 text-base sm:text-lg max-w-4xl xl:max-w-5xl mx-auto leading-relaxed text-pretty">
					<span class="block"
				...
				<div class="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
					...
					<router-link
						to="/showcase"
						class="w-full sm:w-auto px-8 py-4 rounded-2xl font-bold text-base text-cyan-300 bg-slate-900/90 hover:bg-slate-850 border border-cyan-500/40 hover:border-cyan-400 shadow-lg hover:text-white transition-all inline-flex items-center justify-center space-x-2"
					>
					...
					<router-link
						to="/community"
						class="w-full sm:w-auto px-8 py-4 rounded-2xl font-bold text-base text-slate-200 bg-slate-900/90 hover:bg-slate-850 border border-slate-700/90 hover:border-slate-600 shadow-lg hover:text-white transition-all inline-flex items-center justify-center space-x-2"
					>
				...
				<div class="pt-4 text-center">
					<p class="text-base text-slate-400 font-medium">
						如果你決定開始，<span class="text-cyan-300 font-bold">我們願意陪你把第一步走得更扎實。</span>
					</p>
				</div>
			</div>
		</section>
